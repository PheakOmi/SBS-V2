                    ...
                    <div class="title-block">
                         <div class="clearfix" style="margin-bottom: 10px;">
                         	...
                         	<div class="btn-group pull-right">
		                        ...
		                        <button data-toggle="tooltip" title="View Schedules In Calendar View" type="button" class="btn btn-info" onclick="window.location.href='input_schedule'" style="color:white;"><i class="fa fa-calendar"></i></button>
		                    </div>
